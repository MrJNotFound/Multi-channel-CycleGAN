"""SPIF-Single (AF): gradient-domain content loss + AF single-channel input.
...
on autofluorescence input.

Dataset: datasets/train_mouse_kidney_single_AF_HE_512
"""
...
if __name__ == "__main__":
    ...
    sys.argv = [
        "train_spif_af.py",
        "--dataroot", "./datasets/train_mouse_kidney_single_AF_HE_512",
        "--name", "mouse_kidney_sp_af_256",
        "--model", "spif_single",
