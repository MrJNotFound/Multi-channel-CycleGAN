...
# 直接写死配置：你自己改这里
# ======================
img_dir = r"C:\Users\30927\Desktop\5\mouse_kidney_DAPI_HE_UTOM\test_latest\images" # 输入文件夹（会递归扫描）
out_dir = r"C:\Users\30927\Desktop\5\mouse_kidney_DAPI_HE_UTOM\test_latest\images_fake"  # 输出文件夹
