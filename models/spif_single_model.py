"""SPIF-Single: gradient-domain content loss with single-channel input.

Standard ResNet generator (no dual heads, no SPIFFusion). Keeps the full
SPIF gradient-domain + low-frequency content loss on single-channel input
(AF or BF → H&E).

Usage: --model spif_single  (--input_nc 1 or 3, --dataset_mode unaligned)
"""
...
class SPIFSingleModel(SPIFModel):
    """SPIF content loss with standard single-channel ResNet generator."""
